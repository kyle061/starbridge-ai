...
type PaymentOrder struct {
	...
	// SubscriptionUsageMultiplier holds the value of the "subscription_usage_multiplier" field.
	SubscriptionUsageMultiplier *float64 `json:"subscription_usage_multiplier,omitempty"`
	// SubscriptionPlanName holds the value of the "subscription_plan_name" field.
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldAmount, paymentorder.FieldPayAmount, paymentorder.FieldFeeRate, paymentorder.FieldSubscriptionQuotaUsd, paymentorder.FieldSubscriptionUsageMultiplier, paymentorder.FieldRefundAmount:
			values[i] = new(sql.NullFloat64)
		case paymentorder.FieldID, paymentorder.FieldUserID, paymentorder.FieldPlanID, paymentorder.FieldSubscriptionGroupID, paymentorder.FieldSubscriptionDays:
			values[i] = new(sql.NullInt64)
		case paymentorder.FieldUserEmail, paymentorder.FieldUserName, paymentorder.FieldUserNotes, paymentorder.FieldRechargeCode, paymentorder.FieldOutTradeNo, paymentorder.FieldPaymentType, paymentorder.FieldPaymentTradeNo, paymentorder.FieldPayURL, paymentorder.FieldQrCode, paymentorder.FieldQrCodeImg, paymentorder.FieldOrderType, paymentorder.FieldSubscriptionPlanName, paymentorder.FieldProviderInstanceID, paymentorder.FieldProviderKey, paymentorder.FieldStatus, paymentorder.FieldRefundReason, paymentorder.FieldRefundRequestReason, paymentorder.FieldRefundRequestedBy, paymentorder.FieldFailedReason, paymentorder.FieldClientIP, paymentorder.FieldSrcHost, paymentorder.FieldSrcURL:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldSubscriptionUsageMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_usage_multiplier", values[i])
			} else if value.Valid {
				_m.SubscriptionUsageMultiplier = new(float64)
				*_m.SubscriptionUsageMultiplier = value.Float64
			}
		case paymentorder.FieldSubscriptionPlanName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_plan_name", values[i])
			} else if value.Valid {
				_m.SubscriptionPlanName = new(string)
				*_m.SubscriptionPlanName = value.String
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SubscriptionUsageMultiplier; v != nil {
		builder.WriteString("subscription_usage_multiplier=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.SubscriptionPlanName; v != nil {
		builder.WriteString("subscription_plan_name=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
