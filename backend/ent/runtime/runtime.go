...
func init() {
	...
	groupDescConcurrencyLimit := groupFields[57].Descriptor()
	...
	// paymentorderDescSubscriptionPlanName is the schema descriptor for subscription_plan_name field.
	paymentorderDescSubscriptionPlanName := paymentorderFields[20].Descriptor()
	// paymentorder.SubscriptionPlanNameValidator is a validator for the "subscription_plan_name" field. It is called by the builders before save.
	paymentorder.SubscriptionPlanNameValidator = paymentorderDescSubscriptionPlanName.Validators[0].(func(string) error)
	...
	// subscriptionplanDescQuotaMultiplier is the schema descriptor for quota_multiplier field.
	subscriptionplanDescQuotaMultiplier := subscriptionplanFields[4].Descriptor()
	// subscriptionplan.DefaultQuotaMultiplier holds the default value on creation for the quota_multiplier field.
	subscriptionplan.DefaultQuotaMultiplier = subscriptionplanDescQuotaMultiplier.Default.(float64)
	// subscriptionplanDescUsageMultiplier is the schema descriptor for usage_multiplier field.
	subscriptionplanDescUsageMultiplier := subscriptionplanFields[5].Descriptor()
	// subscriptionplan.DefaultUsageMultiplier holds the default value on creation for the usage_multiplier field.
	subscriptionplan.DefaultUsageMultiplier = subscriptionplanDescUsageMultiplier.Default.(float64)
	...
	// usersubscriptionDescQuotaUsd is the schema descriptor for quota_usd field.
	usersubscriptionDescQuotaUsd := usersubscriptionFields[11].Descriptor()
	// usersubscription.DefaultQuotaUsd holds the default value on creation for the quota_usd field.
	usersubscription.DefaultQuotaUsd = usersubscriptionDescQuotaUsd.Default.(float64)
	// usersubscriptionDescQuotaUsedUsd is the schema descriptor for quota_used_usd field.
	usersubscriptionDescQuotaUsedUsd := usersubscriptionFields[12].Descriptor()
	// usersubscription.DefaultQuotaUsedUsd holds the default value on creation for the quota_used_usd field.
	usersubscription.DefaultQuotaUsedUsd = usersubscriptionDescQuotaUsedUsd.Default.(float64)
	// usersubscriptionDescUsageMultiplier is the schema descriptor for usage_multiplier field.
	usersubscriptionDescUsageMultiplier := usersubscriptionFields[13].Descriptor()
	// usersubscription.DefaultUsageMultiplier holds the default value on creation for the usage_multiplier field.
	usersubscription.DefaultUsageMultiplier = usersubscriptionDescUsageMultiplier.Default.(float64)
	// usersubscriptionDescPlanName is the schema descriptor for plan_name field.
	usersubscriptionDescPlanName := usersubscriptionFields[14].Descriptor()
