...
func setDefaults() {
	...
	viper.SetDefault("webauthn.rp_display_name", "Starbridge AI")
	...
	viper.SetDefault("billing.retail_pricing.standard_multiplier", 12.0)
	viper.SetDefault("billing.retail_pricing.latest_multiplier", 12.0)
	...
	viper.SetDefault("billing.gpt6_preparation.preparation_multiplier", 12.0)
	...
	viper.SetDefault("default.user_concurrency", 8)
