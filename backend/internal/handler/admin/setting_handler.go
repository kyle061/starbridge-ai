...
type SettingHandler struct {
	...
	secretBackupService       *service.BackupService
	secretImageStorageService *service.ImageStorageSettingService
}
...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		ResendFallbackEnabled:                                  settings.ResendFallbackEnabled,
		EmailProvider:                                          settings.EmailProvider,
		BrevoAPIKeyConfigured:                                  settings.BrevoAPIKeyConfigured,
