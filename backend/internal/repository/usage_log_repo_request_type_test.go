...
func TestUsageLogRepositoryGetUserSpendingRanking(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"user_id", "email", "username", "cost", "actual_cost", "requests", "tokens", "total_cost", "total_actual_cost", "total_requests", "total_tokens"}).
		AddRow(int64(2), "beta@example.com", "beta", 10.0, 12.5, int64(9), int64(900), 36.75, 40.0, int64(30), int64(2600)).
		AddRow(int64(1), "alpha@example.com", "alpha", 9.5, 12.5, int64(8), int64(800), 36.75, 40.0, int64(30), int64(2600)).
		AddRow(int64(3), "gamma@example.com", "", 17.25, 4.25, int64(5), int64(300), 36.75, 40.0, int64(30), int64(2600))
	...
	require.Equal(t, &usagestats.UserSpendingRankingResponse{
		Ranking: []usagestats.UserSpendingRankingItem{
			{UserID: 2, Email: "beta@example.com", Username: "beta", Cost: 10.0, ActualCost: 12.5, Requests: 9, Tokens: 900},
			{UserID: 1, Email: "alpha@example.com", Username: "alpha", Cost: 9.5, ActualCost: 12.5, Requests: 8, Tokens: 800},
			{UserID: 3, Email: "gamma@example.com", Cost: 17.25, ActualCost: 4.25, Requests: 5, Tokens: 300},
		},
		TotalCost:       36.75,
