...
const (
	...
	configuredCodexCustomDescription   = "Custom model routed through Starbridge AI."
...
func newConfiguredCodexModelDescriptor(modelID string) configuredCodexModelDescriptor {
	...
	if isDeepSeekCodexModel(modelID) {
		...
		descriptor.Description = "DeepSeek coding and reasoning model routed through Starbridge AI."
	...
	if isGrokCodexModel(modelID) {
		...
		descriptor.Description = "Grok coding and reasoning model routed through Starbridge AI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isClaudeCodexModel(modelID) {
		...
		descriptor.Description = "Claude coding and reasoning model routed through Starbridge AI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isOpenAICodexGPTModel(modelID) {
		...
		descriptor.Description = "OpenAI GPT coding model routed through Starbridge AI."
		descriptor.SupportsParallelToolCalls = true
