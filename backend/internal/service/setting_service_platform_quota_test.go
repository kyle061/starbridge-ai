...
func TestUpdateSettingsWithAuthSourceDefaults_PlatformQuotaRoundTrip(t *testing.T) {
	svc := newSettingServiceForPlatformQuotaTest(nil)
	systemSettings := &SystemSettings{CustomerBillingMultiplier: CustomerBillingMultiplierDefault}
...
func TestUpdateSettingsWithAuthSourceDefaults_NilPlatformQuotaPreservesExisting(t *testing.T) {
	...
	if err := svc.UpdateSettingsWithAuthSourceDefaults(context.Background(), &SystemSettings{CustomerBillingMultiplier: CustomerBillingMultiplierDefault}, authDefaults); err != nil {
		t.Fatalf("UpdateSettingsWithAuthSourceDefaults: %v", err)
	}
...
func TestUpdateSettingsWithAuthSourceDefaults_NegativeQuotaRejected(t *testing.T) {
	...
	err := svc.UpdateSettingsWithAuthSourceDefaults(context.Background(), &SystemSettings{CustomerBillingMultiplier: CustomerBillingMultiplierDefault}, authDefaults)
