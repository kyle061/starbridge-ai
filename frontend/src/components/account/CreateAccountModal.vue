  ...
  >
    ...
    >
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-green-200 bg-green-50 px-3 py-2 text-xs leading-5 text-green-800 dark:border-green-800/50 dark:bg-green-900/20 dark:text-green-200"
          data-testid="openai-oauth-pro-hint"
        >
          {{ t('admin.accounts.providerPresets.openaiOAuthHint') }}
        </div>
      </div>
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        <div v-if="!isMultiProtocolPlatform || apiProtocol !== 'adaptive'">
          ...
          <OpenAIProviderPresets
            v-if="form.platform === 'openai'"
            class="mt-3"
            :current-url="apiKeyBaseUrl"
            :responses-mode="openAIResponsesMode"
            @select="applyOpenAIProviderPreset"
          />
          <GrokBaseUrlPresets
    ...
    <div v-else class="space-y-5">
      <OAuthAuthorizationFlow
        ...
        :method-label="t('admin.accounts.oauth.authMethod')"
...
import OpenAIProviderPresets from '@/components/account/OpenAIProviderPresets.vue'
import type { OpenAIProviderPreset } from '@/components/account/openaiProviderPresets'
...
function applyOpenAIProviderPreset(preset: OpenAIProviderPreset) {
