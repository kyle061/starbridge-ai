...
<template>
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    <div
      ...
      :key="index"
      class="flex w-full min-w-0 flex-wrap items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs transition-colors hover:border-primary-200 dark:border-dark-600 dark:bg-dark-800 dark:hover:border-primary-700 sm:w-auto"
    >
      <span class="break-words font-medium text-gray-600 dark:text-gray-300">{{ item.name }}</span>
      <span
        v-if="item.isDefault"
      ...
      <div class="group/endpoint relative flex w-full min-w-0 items-center gap-1.5 sm:w-auto">
        ...
        <button
          type="button"
          class="flex min-h-11 min-w-11 shrink-0 items-center justify-center rounded p-0.5 transition-colors sm:min-h-0 sm:min-w-0"
        ...
        <a
          ...
          class="flex min-h-11 min-w-11 shrink-0 items-center justify-center rounded p-0.5 text-gray-400 transition-colors hover:text-amber-500 dark:text-gray-500 dark:hover:text-amber-400 sm:min-h-0 sm:min-w-0"
