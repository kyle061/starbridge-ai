  ...
  >
    ...
    <div class="flex flex-1 flex-col p-4">
      ...
      <div class="mb-3 grid grid-cols-2 gap-x-3 gap-y-1 rounded-lg bg-gray-50 px-3 py-2 text-xs dark:bg-dark-700/50">
        ...
        <PlanModelList class="col-span-2" :allowlist="plan.model_allowlist" :platform="plan.group_platform" :scopes="plan.supported_model_scopes" />
      </div>
...
import PlanModelList from './PlanModelList.vue'
