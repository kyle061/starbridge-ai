    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          device: {
            label: "Device code sign-in (recommended for mobile)",
            description: "Get a device code, then sign in on the official OpenAI page and enter the code. Switch back here after approval; this site will receive the result and bind your account.",
            enableHint: "First enable device code login under ChatGPT → Settings → Security. If unavailable, use manual callback sign-in or import a Codex session.",
            returnAddress: "Account binding page (current site)",
            start: "Get a login device code",
            starting: "Getting device code…",
            codeLabel: "One-time device code (valid for 15 minutes)",
            open: "Open OpenAI sign-in",
            waiting: "Waiting for approval. Switch back here after signing in.",
            authorized: "Authorized. Saving your account; retry if saving fails.",
            save: "Retry saving account",
            restart: "Get a new device code",
            expired: "Device code or session expired. Get a new code.",
            retrying: "Temporarily unable to check authorization. Retrying…",
            failed: "Could not get a device code. Check your proxy connection and enable device code login in ChatGPT security settings.",
          },
          chatgptLogin: 'Manual callback sign-in (Plus / Pro)',
          step1GenerateUrl: 'Click the button below to generate the authorization URL',
          generateAuthUrl: 'Generate Auth URL',
          ...
          importantNotice:
            'After approval, the browser will return to the public Starbridge callback {callbackUrl}. Copy the complete address-bar URL and paste it into step 3. On mobile, press and hold the address bar to copy it.',
          step3EnterCode: 'Paste the OpenAI callback URL',
          authCodeDesc:
