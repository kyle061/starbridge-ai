    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          importantNotice:
            'The Codex OAuth client uses the local callback {callbackUrl}. After approval, copy the complete address-bar URL even if the page cannot connect, then paste it into step 3. On mobile, press and hold the address bar to copy it.',
