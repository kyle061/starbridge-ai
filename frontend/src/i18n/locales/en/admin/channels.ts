export default {
    ...
    channels: {
      ...
      form: {
        ...
        modelPricing: 'Model Pricing (Raw Channel Data)',
        rawPricingHint: 'Admin view: these are the channel prices before the client-wide billing multiplier is applied.',
        models: 'Models',
        modelsPlaceholder: 'Type full model name and press Enter',
        modelInputHint: 'Press Enter to add, supports paste for batch import.',
        billingMode: 'Billing Mode',
        defaultPrices: 'Raw channel prices (fallback when no interval matches)',
        inputPrice: 'Input',
        outputPrice: 'Output',
        cacheWritePrice: 'Cache Write',
        cacheWrite5mPrice: 'Cache Write (5m)',
    ...
    riskControl: {
      ...
      baseUrlRequired: 'Enter an OpenAI Base URL',
      baseUrlInvalid: 'OpenAI Base URL must be a valid HTTP/HTTPS URL',
      modelRequired: 'Enter a moderation model',
      invalidRange: '{field} must be between {min} and {max}',
      invalidThreshold: 'Risk thresholds must be between 0% and 100%',
      groupScopeRequired: 'Select at least 1 audit group when all groups is disabled',
      preBlockApiKeyRequired: 'Configure at least 1 usable moderation API key before enabling content moderation',
    ...
    subscriptions: {
      ...
      totalQuota: 'Total subscription quota (¥)',
      editQuota: 'Set quota',
      editMultiplier: 'Edit subscription multiplier',
      quotaHint: 'API requests consume this subscription quota. Requests stop when it is exhausted. It does not reset daily.',
      quotaEditHint: 'Sets the total while preserving usage and expiry. For legacy subscriptions without a quota, tracking starts after saving.',
      quotaRequired: 'Enter a positive quota and usage multiplier',
      quotaBelowUsage: 'Total quota cannot be lower than consumed quota',
      subscriptionMultiplier: 'This subscription usage multiplier',
      subscriptionMultiplierHint: 'Affects only this subscription. It does not change the group default, plan default, or other subscriptions. This is the final multiplier for this subscription.',
      assignmentMultiplierHint: 'Set an individual multiplier during assignment. It applies only to this subscription and does not change the group default.',
      multiplierRequired: 'Enter a positive subscription usage multiplier',
      planTemplate: 'Use plan settings',
      customQuota: 'Custom quota',
      planTemplateHint: 'Select a plan to fill validity, quota and billing settings, or adjust them manually.',
