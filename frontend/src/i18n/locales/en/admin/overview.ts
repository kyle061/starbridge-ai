export default {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. starbridge-backups), choose a region',
    ...
    groups: {
      ...
      columns: {
        ...
        id: 'ID',
        platform: 'Platform',
        rateMultiplier: 'Group default multiplier',
      ...
      form: {
        ...
        rateMultiplierLabel: 'Group default multiplier',
        rateMultiplierHint: 'Default billing multiplier for this group; subscription assignments can set an individual multiplier. 1.0 = standard, 0.5 = half price, 2.0 = double',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
        rpmLimitHint: 'Max requests per minute for each user in this group; 0 = unlimited. Once set, it takes over per-user rate limiting in this group (overrides the user-level rpm_limit fallback).',
        concurrencyLimit: 'Group total concurrency',
        concurrencyLimitPlaceholder: '1000',
        concurrencyLimitHint: 'Independent group-wide cap. Effective capacity is the lower of this value and the sum of schedulable account concurrency. 0 uses the account sum.',
        ...
        reasoningEffortModelPlaceholder: 'Empty = all / gpt / gpt-5.6-sol',
      ...
      compositeRoutes: {
        ...
        routes: 'Saved Routes',
        failoverHint: 'Add multiple routes for the same public model. Lower priority numbers run first, and requests move to the next compatible route when no account is available.',
        ...
        fallbackRoute: 'Fallback {index}',
        failoverChain: 'Failover Order',
        addRoute: 'Add Route',
        ...
        routeCreated: 'Route added to the failover chain',
      ...
      openaiMessages: {
        ...
        sonnetModelPlaceholder: 'e.g., gpt-5.6-terra',
        haikuModel: 'Haiku Target Model',
        haikuModelPlaceholder: 'e.g., gpt-5.6-luna',
        ...
        targetModelPlaceholder: 'e.g., gpt-5.6-sol',
        removeExactMapping: 'Remove Exact Mapping'
      },
      openaiLive: {
        title: 'OpenAI Live',
        allow: 'Allow Live access',
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The Starbridge AI server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
        unsupportedTitle: 'Current server does not support Live',
        unsupportedMessage: 'This Starbridge AI server cannot generate the required Live attestation. Live will not work even if enabled. Continue anyway?',
