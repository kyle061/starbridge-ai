    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          freezeHoursDesc: 'New rebates will be frozen for this period before they can be transferred to the account balance. 0 = no freeze.',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Starbridge AI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Starbridge AI end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, Starbridge AI temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by compatible upstream relay sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Starbridge AI',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'Multi-model AI API Gateway',
        ...
        contactInfo: 'WeChat Contact',
        contactInfoPlaceholder: 'e.g., WeChat: your_wechat_id',
        contactInfoHint: 'Enter a WeChat ID, optionally prefixed with “WeChat:”. All contact entries share this value and support copying. Email and HTTPS contact pages are also supported.',
      ...
      payment: {
        ...
        validationEasyPaySigningRequired: 'EasyPay requires either both RSA private/public keys or the merchant Key for the classic MD5 protocol',
        ...
        field_ezfpApiBaseHint: 'For ezfp, enter the provider root such as https://www.ezfp.cn. An API info page such as https://www.ezfp.cn/user/userinfo.php?mod=api is also normalized automatically; do not enter a specific /api/pay/create endpoint.',
        ...
        field_pkey: 'Merchant Key (classic MD5 protocol)',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Starbridge AI orders; the upstream type is sent as EasyPay type.',
      ...
      resend: {
        ...
        apiKeyPlaceholder: 'Enter your real re_ API key',
        apiKeyHint: 'Replace the re_xxxxxxxxx example with a real key created in the Resend dashboard.',
        apiKeyConfiguredPlaceholder: '********',
        apiKeyConfiguredHint: 'A key is configured. Leave this blank to keep it.',
        fromEmail: 'Backup From Email',
