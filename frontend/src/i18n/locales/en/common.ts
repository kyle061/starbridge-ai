export default {
  ...
  adminCompliance: {
    ...
    openDocument: 'Open the platform document',
  ...
  legal: {
    ...
    empty: 'No content',
    emptyTitle: 'Document content is not configured',
    emptyDescription: 'An administrator can add Markdown content under Settings → Login agreement. Review the text before enabling mandatory consent.',
    documentNavigation: 'Documents',
    backHome: 'Back to home',
    loginAgreement: 'Terms and Privacy',
    adminCompliance: 'Deployment and Operation Compliance Commitment',
    loginAgreementPrompt: {
      checkboxPrefix: 'I have read and agree to the following terms, privacy policy, and usage rules: ',
      documentSeparator: ', ',
      noticeTitle: 'Accept the latest terms before continuing.',
      noticeDescription: 'Account/password login and quick sign-in stay disabled until you accept. Open each document to review the details.',
      viewTerms: 'View terms',
      dialogTitle: 'Terms Update Notice',
      dialogDescription: '{site} terms, privacy policy, and usage rules were updated on {date}. Please read and accept the following documents before continuing.',
      recently: 'recently',
  ...
  auth: {
    ...
    rememberMeHint: 'Stay signed in for 30 days',
