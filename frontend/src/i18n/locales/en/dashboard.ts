  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        authModeDescription: 'Environment variable mode is recommended. Inline mode is available when the client cannot inherit environment variables.',
        authModeEnvKey: 'Environment variable (recommended)',
        authModeApiKey: 'Inline API key',
        ...
        configTomlEnvKeyHint: 'This configuration reads the API key from SUB2API_API_KEY and is safe to keep separate from the secret.',
        configTomlHint: 'This configuration contains the plaintext API key. Keep it private and do not commit it.',
        note: 'Run the Terminal command in the same shell that launches Codex CLI, then save config.toml under ~/.codex. For Codex Desktop, expose SUB2API_API_KEY to the app process or use Inline API key mode.',
        noteWindows: 'Run the PowerShell command before launching Codex CLI, then save config.toml under %userprofile%\\.codex. For Codex Desktop, expose SUB2API_API_KEY to the app process or use Inline API key mode.',
      },
      cliTabs: {
