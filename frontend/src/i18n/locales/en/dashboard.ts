export default {
  ...
  keys: {
    ...
    prepaidPurchaseStatus: 'Top-up required',
    ...
    requestedGroupUnavailable: 'This subscription group is currently unavailable. Refresh your subscription and API key pages, then retry.',
    statusLabel: 'Status',
    ...
    groupChangeConfirm: 'Switching to “{group}” immediately changes this key’s available models, multiplier, and billing source. Continue?',
    ...
    sharedSubscriptionQuota: 'Current shared subscription quota (all keys)',
    sharedSubscriptionRemaining: 'Subscription remaining',
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        authModeDescription: 'The default writes the key into config.toml so one file is enough. Environment mode is available when you prefer not to store the key there.',
      ...
      gemini: {
        ...
        modelComment: 'Use a currently supported model, for example: gemini-3.5-flash',
        note: 'These environment variables will be active in the current terminal session. For permanent configuration, add them to ~/.bashrc, ~/.zshrc, or the appropriate configuration file.',
      },
      grok: {
        description:
      ...
      deepseek: {
        ...
        codexNote: 'config.toml contains the plaintext API key; do not commit it.',
      },
      minimax: {
      ...
      routedCodex: {
        ...
        configTomlHint: 'The API key is included. Save as config.toml and restart Codex. Set model to a model supported by this group.',
        note: 'config.toml contains the plaintext API key; do not commit it.',
      },
      opencode: {
    ...
    ccsCodex: {
      ...
      step1: 'In CCS → Codex, back up and copy the full config.toml from your existing provider, then paste it below.',
      step2: 'Copy the merged result and paste it into the existing CCS provider’s config editor. Do not use “Import directly to CCS” afterwards: it creates a default provider.',
      step3: 'Select the updated existing provider in CCS, then reopen Codex. Your model, authentication and session settings are retained.',
      copyEndpoint: 'Copy endpoint',
      copyKey: 'Copy API key',
      preserveHint: 'The current CCS import protocol rebuilds default Codex settings and cannot directly import while preserving yours. This mode merges the endpoint and key into your original config.toml; paste the result into your existing provider in CCS. Only “Import without keeping settings” creates a new provider.',
      configLabel: 'Full config.toml from your existing CCS provider (processed locally)',
      ...
      copyAndOpenCcs: 'Copy merged config for existing CCS provider',
      mergedCopied: 'Merged config.toml copied. Paste it into your existing provider in CCS.',
      copyResult: 'Copy merged configuration only',
      errors: {
    ...
    rateLimit5hShort: '5 hours',
    rateLimit1dShort: '1 day',
    rateLimit7dShort: '7 days',
    rateLimitUnlimited: 'Unlimited',
    rateLimitResetAt: 'Resets {time}',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      paidPrice: 'Client Price',
      officialPrice: 'Upstream Reference Price',
      rate: 'Billing Multiplier',
      unitPerMillion: '$ / 1M tokens',
