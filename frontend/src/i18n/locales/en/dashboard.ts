export default {
  ...
  keys: {
    ...
    ccsCodex: {
      ...
      preserveHint: 'The CCS protocol can only create a new import provider; it cannot overwrite the existing provider directly. Click “Copy config and open CCS” to copy the complete config.toml first, then open the CCS Codex import entry. Paste it into your existing provider in CCS to keep its original settings.',
      ...
      copyAndOpenCcs: 'Copy config and open CCS',
