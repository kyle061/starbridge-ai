  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        authModeDescription: 'Compatibility mode is selected by default and includes the API key in config.toml. API Key mode is also available.',
        authModeLegacy: 'Compatibility (recommended)',
