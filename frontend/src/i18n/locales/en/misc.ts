export default {
  ...
  userSubscriptions: {
    ...
    guide: {
      ...
      step2: {
        ...
        description: 'Click Use Key, choose Codex or another client, and copy the configuration with the site endpoint and API key. For CCS, click Import to CCS and choose whether to keep existing settings or import a new configuration. Choose a model included in your plan.'
      },
      step3: {
    ...
    quotaExhausted: 'Subscription quota exhausted. API requests using this subscription are stopped.',
    quotaNotConfigured: 'No total subscription quota configured. Contact your administrator.',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Starbridge AI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Starbridge AI AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    comingSoon: {
      badge: 'Coming soon',
      title: 'Online top-up is coming soon',
      description: 'Alipay and WeChat Pay will be available once online payment is ready.',
      availableTitle: 'Available top-up methods',
      availableDescription: 'Top up through an administrator or redeem code. Once credited, create a key or continue using your existing key.',
    ...
    errors: {
      ...
      INVALID_SUBSCRIPTION_DAYS: 'Purchase days must be between 1 and 365.',
      PLAN_NOT_DAILY: 'Only one-day plans support selecting multiple purchase days.',
    ...
    decreaseDays: 'Decrease by one day',
    increaseDays: 'Increase by one day',
    currentDiscount: 'Current discount',
    quickDuration: 'Discount duration shortcuts',
    customDays: 'Custom days',
    fullPrice: 'Standard price',
    discountRate: '{discount}/10 price',
    subscriptionValidity: 'Subscription validity',
    dayCount: '{days} days',
    dailyResetAtMidnight: 'For multi-day purchases, the daily allowance resets at 00:00 China Standard Time. Maximum 365 days.',
    planCard: {
      remainingQuota: 'Remaining quota',
      entitlementBased: 'Usage follows your subscription entitlements',
      modelsByRoute: 'Models depend on the current route',
      rate: 'Rate',
      peakRate: 'Peak Rate',
      dailyLimit: 'Daily',
      weeklyLimit: 'Weekly',
    ...
    admin: {
      ...
      dailyPlanHint: 'Set validity to 1 day to enable multi-day purchases. The daily allowance comes from the selected subscription group. Purchases of 15/30/45/60 days are billed at 95/90/85/80%; multi-day subscriptions reset at 00:00 daily.',
      ...
      planModelsHint: 'Use Configure models in the plan list. Use separate groups for different tiers.',
      modelsEnabled: 'Allow selected models only',
      modelsHint: 'Changes apply to existing and new subscriptions in this group. Candidates do not guarantee upstream availability.',
      sharedModelsWarning: 'This group is shared by {plans}. Changes affect all of them. Assign separate groups to configure tiers independently.',
      modelSearch: 'Search models',
      modelCustom: 'Enter a model ID or prefix wildcard, e.g. gpt-*',
      modelsLoadError: 'Could not load model settings. Please retry.',
      retryModels: 'Reload',
      noModelMatches: 'No matching models. Add one below.',
