export default {
  ...
  legal: {
    ...
    empty: '暂无正文内容',
    emptyTitle: '文档正文尚未配置',
    emptyDescription: '管理员可以在设置 → 登录条款中补充 Markdown 正文。启用强制确认前，请先完成内容审阅。',
    documentNavigation: '条款目录',
    backHome: '返回首页',
    loginAgreement: '服务条款与隐私政策',
    adminCompliance: '部署与运营合规承诺',
    loginAgreementPrompt: {
      checkboxPrefix: '我已阅读并同意以下服务条款、隐私政策及使用规则：',
      documentSeparator: '、',
      noticeTitle: '继续登录前需要先同意最新条款。',
      noticeDescription: '未同意前，账号密码输入和快捷登录会保持禁用。请先打开文档查看具体内容。',
      viewTerms: '查看条款',
      dialogTitle: '条款更新通知',
      dialogDescription: '{site} 的服务条款、隐私政策和使用规则已于 {date} 更新。在继续使用服务之前，请仔细阅读并同意以下文档。',
      recently: '近期',
