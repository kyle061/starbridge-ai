export default {
  ...
  keys: {
    ...
    ccsCodex: {
      ...
      copyEndpoint: '复制接口地址',
      copyKey: '复制 API 密钥',
      preserveHint: 'CCS 协议只能创建新的导入供应商，不能直接覆盖原供应商。生成后点击“复制配置并打开 CCS”：系统会先复制完整 config.toml，再打开 CCS Codex 导入入口；在 CCS 中将配置粘贴回原供应商，即可保留原有参数。',
