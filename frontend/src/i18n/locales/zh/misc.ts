export default {
  ...
  userSubscriptions: {
    ...
    guide: {
      ...
      step2: {
        title: '配置客户端',
        description: '点击「使用密钥」选择 Codex 或其他客户端，复制包含本站接口地址和密钥的配置。使用 CCS 时点击「导入到 CCS」，可选择保留原配置或直接导入新配置。模型须在套餐支持范围内。'
      },
      step3: {
        title: '调用并查看消耗',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Starbridge AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Starbridge AI 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Starbridge AI 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 Starbridge AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 Starbridge AI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    comingSoon: {
      badge: '暂未开放',
      title: '在线充值暂未开放',
      description: '支付渠道准备中，开放后将支持支付宝和微信支付。',
      availableTitle: '当前充值方式',
      availableDescription: '目前支持管理员后台充值和兑换码充值，到账后即可创建或继续使用原 Key。',
      redeem: '使用兑换码充值',
    },
    ...
    errors: {
      ...
      INVALID_SUBSCRIPTION_DAYS: '购买天数必须在 1 到 365 天之间',
      PLAN_NOT_DAILY: '只有 1 天有效期的套餐支持选择购买天数',
    ...
    decreaseDays: '减少一天',
    increaseDays: '增加一天',
    subscriptionValidity: '订阅有效期',
    dayCount: '{days} 天',
    dailyResetAtMidnight: '购买多日时，每日额度在北京时间 0 点重置，最多购买 365 天',
    multiDayDiscount: '已享 {discount}% 优惠',
    planCard: {
      remainingQuota: '剩余额度',
      entitlementBased: '按订阅权益使用',
      modelsByRoute: '以当前线路支持的模型为准',
      rate: '倍率',
      peakRate: '高峰倍率',
      dailyLimit: '日限额',
      weeklyLimit: '周限额',
    ...
    admin: {
      ...
      validity: '有效期',
      validityUnit: '有效期单位',
      dailyPlanHint: '将有效期设置为 1 天可启用按天购买。日额度取所选订阅分组的日限额，购买满 15/30/45/60 天分别按 95/90/85/80 折结算；多日订阅每天 0 点重置。',
      sortOrder: '排序',
      forSale: '上架状态',
      onSale: '上架',
      offSale: '下架',
      ...
      planModelsHint: '在套餐列表点击「配置模型」设置可用模型；不同版本请使用独立分组。',
      modelsEnabled: '仅允许选中的模型',
      modelsHint: '保存后立即应用到此分组的现有及新订阅；候选列表不代表上游已开通。',
      sharedModelsWarning: '此分组由 {plans} 共用，修改会同时生效。需要独立配置时，请先为套餐选择独立分组。',
      modelSearch: '搜索模型',
      modelCustom: '输入模型 ID 或前缀通配符，如 gpt-*',
      modelsLoadError: '模型配置加载失败，请重试',
      retryModels: '重新加载',
      noModelMatches: '没有匹配的模型，可在下方添加',
