...
export function buildCcSwitchImportDeeplink(input: CcSwitchImportDeeplinkInput): string {
  ...
  // Use this template only after the user explicitly chooses a new config.
  if (config.app === 'codex' && input.codexImportMode !== 'new') {
    throw new Error('Codex requires the existing-config binding flow')
  }
