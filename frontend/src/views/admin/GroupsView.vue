  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <div>
          <label class="input-label">{{ t("admin.groups.form.concurrencyLimit") }}</label>
          <input
            v-model.number="createForm.concurrency_limit"
            type="number"
            min="0"
            step="1"
            class="input"
            :placeholder="t('admin.groups.form.concurrencyLimitPlaceholder')"
          />
          <p class="input-hint">{{ t("admin.groups.form.concurrencyLimitHint") }}</p>
        </div>
    ...
    >
      ...
      >
        ...
        <div>
          <label class="input-label">{{ t("admin.groups.form.concurrencyLimit") }}</label>
          <input
            v-model.number="editForm.concurrency_limit"
            type="number"
            min="0"
            step="1"
            class="input"
        ...
        <section class="min-w-0">
          ...
          >
            ...
            <div v-else class="overflow-x-auto">
              <table class="modal-mobile-table min-w-full divide-y divide-gray-200 text-sm dark:divide-dark-600">
                ...
                <tbody class="divide-y divide-gray-100 bg-white dark:divide-dark-700 dark:bg-dark-900">
                  ...
                  >
                    <td :data-label="t('admin.groups.compositeRoutes.publicModel')" class="max-w-[15rem] px-3 py-2">
                    ...
                    <td :data-label="t('admin.groups.compositeRoutes.target')" class="px-3 py-2">
                    ...
                    <td :data-label="t('admin.groups.compositeRoutes.scope')" class="px-3 py-2">
...
const createForm = reactive({
  ...
  // 分组总并发上限（独立于账号并发；0 = 按账号并发总和）
  concurrency_limit: 1000 as number,
...
const closeCreateModal = () => {
  ...
  createForm.rate_multiplier = 6.0;
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editForm.concurrency_limit = group.concurrency_limit ?? 1000;
